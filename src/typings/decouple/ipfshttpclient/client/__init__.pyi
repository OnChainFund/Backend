...
class LogSection(base.SectionBase):
	...
	def level(self, subsystem: str, level: str, **kwargs: base.CommonArgs): # -> List[json_dict_t]:
	...
	@base.returns_single_item(base.ResponseBase)
	def ls(self, **kwargs: base.CommonArgs): # -> List[json_dict_t]:
	...
	def tail(self, **kwargs: base.CommonArgs): # -> StreamDecodeIteratorSync[json_dict_t]:
...
class RefsSection(base.SectionBase):
	...
	def __call__(self, cid: base.cid_t, **kwargs: base.CommonArgs): # -> List[json_dict_t]:
	...
	@base.returns_multiple_items(base.ResponseBase)
	def local(self, **kwargs: base.CommonArgs): # -> List[json_dict_t]:
