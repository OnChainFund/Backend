...
_Query = Union[None, str, Mapping[str, _QueryVariable], Sequence[Tuple[str, _QueryVariable]]]
@final
class URL:
    scheme: Final[str]
    raw_user: Final[str]
    ...
    parent: Final[URL]
    def __init__(self, val: Union[str, URL] = ..., *, encoded: bool = ...) -> None:
        ...
    
    @classmethod
    def build(cls, *, scheme: str = ..., authority: str = ..., user: Optional[str] = ..., password: Optional[str] = ..., host: str = ..., port: Optional[int] = ..., path: str = ..., query: Optional[_Query] = ..., query_string: str = ..., fragment: str = ..., encoded: bool = ...) -> URL:
        ...
...
def cache_configure(*, idna_encode_size: Optional[int] = ..., idna_decode_size: Optional[int] = ...) -> None:
    ...
