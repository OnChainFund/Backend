...
def apply_formatter_if(condition: Callable[..., bool], formatter: Callable[..., TReturn] = ..., value: TValue = ...) -> Union[Callable[[Callable[..., TReturn]], Callable[[TValue], Union[TReturn, TValue]]], Callable[[TValue], Union[TReturn, TValue]], TReturn, TValue,]:
    ...
...
@overload
def apply_formatters_to_dict(formatters: Dict[Any, Any], value: Dict[Any, Any]) -> TReturn:
    ...

def apply_formatters_to_dict(formatters: Dict[Any, Any], value: Optional[Dict[Any, Any]] = ...) -> TReturn:
    ...
