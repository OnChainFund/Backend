...
import abc
from typing import Dict, Generic, Iterable, Iterator, List, Mapping, MutableMapping, Tuple, TypeVar, Union, overload
...
_Arg = Union[Mapping[str, _T], Mapping[istr, _T], Dict[str, _T], Dict[istr, _T], MultiMapping[_T], Iterable[Tuple[str, _T]], Iterable[Tuple[istr, _T]]]
...
class MultiDictProxy(MultiMapping[_T], Generic[_T]):
    def __init__(self, arg: Union[MultiMapping[_T], MutableMultiMapping[_T]]) -> None:
        ...
...
def getversion(md: Union[MultiDict[_T], CIMultiDict[_T], MultiDictProxy[_T], CIMultiDictProxy[_T]]) -> int:
    ...
