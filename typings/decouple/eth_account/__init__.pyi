...
from eth_utils.curried import ValidationError, keccak, text_if_str, to_bytes, to_canonical_address, to_text
from hexbytes import HexBytes
from eth_account._utils.structured_data.hashing import hash_domain, hash_message as hash_eip712_message, load_and_validate_structured_message
...
def encode_intended_validator(validator_address: Union[Address, str], primitive: bytes = ..., *, hexstr: str = ..., text: str = ...) -> SignableMessage:
    """
...
def encode_structured_data(primitive: Union[bytes, int, Mapping] = ..., *, hexstr: str = ..., text: str = ...) -> SignableMessage:
    """
...
def encode_defunct(primitive: bytes = ..., *, hexstr: str = ..., text: str = ...) -> SignableMessage:
    r"""
...
def defunct_hash_message(primitive: bytes = ..., *, hexstr: str = ..., text: str = ...) -> HexBytes:
    """
